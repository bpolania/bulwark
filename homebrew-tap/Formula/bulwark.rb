class Bulwark < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/bpolania/bulwark/releases/download/v0.2.0/bulwark-aarch64-apple-darwin.tar.gz"
      sha256 "bb0c8f6c526c3d0f00cebeb7e12aca7fc1c12d5a32eac5e0880e0827ae8fc2b4"
    end
    on_intel do
      url "https://github.com/bpolania/bulwark/releases/download/v0.2.0/bulwark-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/bpolania/bulwark/releases/download/v0.2.0/bulwark-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "c568811fec7fad8da16343c109eddb9db1f293b16c9953a3f980c9ac0a60a394"
    end
    on_intel do
      url "https://github.com/bpolania/bulwark/releases/download/v0.2.0/bulwark-x86_64-unknown-linux-gnu.tar.gz"
